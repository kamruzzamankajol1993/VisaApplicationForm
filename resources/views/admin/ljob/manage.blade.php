...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <a class="btn btn-primary waves-effect" href="{{ route('ljob.create') }}">
                ...
                <li class="list-group-item" data-id="{{$cat->id}}">
                    ...
                    <h6>{{$cat->l_job}}</h6>
                     <div style="margin-left: 334px;"><button class="btn btn-danger waves-effect" type="button" onclick="deleteTag({{ $cat->id }})">
                                                ...
                                                <form id="delete-form-{{ $cat->id }}" action="{{ route('ljob.destroy',$cat->id) }}" method="POST" style="display: none;">
                                                    @csrf
