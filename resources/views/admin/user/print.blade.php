...
<ul>
  ...
  <li>
    <b>Bangladesh Reference Name & Phone:</b> {{$info->refrence_bd_name.", ".$info->refrence_bd_number}}
  </li><br>
  <li>
    <b>UAE Reference Name & Phone:</b> {{$info->refrence_uae_name.", ".$info->refrence_uae_number}}
  </li><br>
  <li>
