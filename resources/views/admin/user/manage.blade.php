...
<section class="content">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         ...
                                         <td class="text-center">
                                            <a href="{{ route('user.show',$student->id) }}" class="btn btn-info waves-effect">
    ...
    <button class="btn btn-danger waves-effect" type="button" onclick="deleteAgent({{ $student->id }})" data-toggle="tooltip" data-placement="top" title="Delete">
            ...
            <form id="delete-form-{{ $student->id }}" action="{{ route('user.destroy',$student->id) }}" method="POST" style="display: none;">
                                                    @csrf
