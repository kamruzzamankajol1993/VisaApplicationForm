...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <a class="btn btn-primary waves-effect" href="{{ route('state.create') }}">
                                    ...
                                    @foreach($states as $key=>$category)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form id="delete-form-{{ $category->id }}" action="{{ route('state.destroy',$category->id) }}" method="POST" style="display: none;">
                                                    @csrf
