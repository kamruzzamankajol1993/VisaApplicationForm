...
{{--    address--}}
    ...
    <section class="section-contact bg1-pattern p-l-30 p-r-30"
             style="background-image: url('{{ asset('public/front-end/images/bg.png') }}')">
                    ...
                    <div class="col-6 nopadding">
                        ...
                        <div class="wrap-inputname    ">
                            <input class=" custom_border_left sizefull txt10 p-l-20 form-control-sm" type="text"
                                   ...
                                   data-parsley-pattern="^[a-zA-Z]+$" data-parsley-trigger="keyup">
                                    <input class=" custom_border_left sizefull txt10 p-l-20 form-control-sm" type="hidden"
                                   name="user_id" id="lname" value="{{ Auth::user()->id }}" placeholder="Last Name" required
                                   data-parsley-pattern="^[a-zA-Z]+$" data-parsley-trigger="keyup">
                        </div>
                    </div>
                </div>
